  ...
  return (
    <div className="min-h-screen bg-black text-white">
          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            >
              ...
              >
                ...
                <span className="text-sm font-medium text-gray-300">🚀 Trusted by 500+ Property Owners</span>
              </motion.div>
              ...
              <div className="flex flex-col sm:flex-row gap-5 justify-center mb-16">
                <Link 
                  href="/register" 
                  className="group relative bg-gradient-to-r from-orange-600 to-amber-600 text-white px-10 py-4 rounded-full font-semibold hover:shadow-2xl hover:shadow-orange-500/30 transition-all duration-300 hover:scale-105 overflow-hidden"
                >
                ...
                <Link 
                  href="/owner/register-property" 
                  className="border-2 border-gray-500 text-gray-300 px-10 py-4 rounded-full font-semibold hover:border-orange-500 hover:text-orange-400 transition-all duration-300 hover:scale-105 backdrop-blur-sm"
                >
                  List Your Property
                </Link>
              </div>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-30">
          <div className="absolute top-0 left-0 w-96 h-96 bg-orange-500 rounded-full mix-blend-multiply filter blur-3xl animate-pulse" />
          <div className="absolute bottom-0 right-0 w-96 h-96 bg-amber-500 rounded-full mix-blend-multiply filter blur-3xl animate-pulse delay-1000" />
        </div>
        ...
        <div className="relative container mx-auto px-4 md:px-8 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-5 justify-center">
              <Link 
                href="/register" 
                className="group bg-gradient-to-r from-orange-600 to-amber-600 text-white px-10 py-4 rounded-full font-semibold hover:shadow-2xl hover:shadow-orange-500/30 transition-all duration-300 hover:scale-105 inline-flex items-center gap-2"
              >
                Start Free Trial
                <span className="group-hover:translate-x-1 transition">→</span>
              </Link>
              <Link 
                href="/owner/register-property" 
                className="border-2 border-gray-500 text-gray-300 px-10 py-4 rounded-full font-semibold hover:border-orange-500 hover:text-orange-400 transition-all duration-300 hover:scale-105 inline-flex items-center gap-2 backdrop-blur-sm"
              >
                List Your Property
              </Link>
            </div>
          ...
          <div className="grid md:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-500">
                ...
                <li><Link href="/owner/register-property" className="hover:text-orange-400 transition">List Property</Link></li>
