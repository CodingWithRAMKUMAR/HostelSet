  ...
  return (
    <div className="min-h-screen max-w-full overflow-x-hidden bg-[#f8f9fa] pb-24 font-sans lg:pb-0">
      ...
      <div className="container mx-auto px-3 sm:px-4 py-5 sm:py-8">
        ...
        {activeTab === 'applications' && <ApplicationList applications={filteredApplications} onApprove={(id, data) => approveApplication(id, data)} onReject={rejectApplication} onResendEmail={resendPasswordEmail} onViewScreenshot={(url) => { setScreenshotUrl(url); setShowScreenshotModal(true) }} isSubmitting={Boolean(applicationProcessingId)} />}
