...
export default function FAQPage() {
  ...
  return <>
    ...
    <main className="min-h-screen bg-slate-50 text-slate-900">
      <header className="border-b border-slate-200 bg-white"><div className="container mx-auto flex items-center justify-between px-4 py-4"><Link href="/" aria-label="HostelSet home"><BrandLogo priority /></Link><Link href="/properties" className="rounded-full bg-slate-900 px-4 py-2 text-sm font-semibold text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-400">Browse properties</Link></div></header>
