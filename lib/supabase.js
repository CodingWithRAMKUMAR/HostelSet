...
// ========== NEW AUTH FUNCTIONS (adds email/password) ==========

// Sign up with email & password (no phone OTP)
export const signUpWithEmail = async (email, password, userData) => {
  try {
    ...
    // Create record in custom users table
...
export const signInWithEmail = async (email, password) => {
  try {
    ...
    // Store session info (compatible with existing localStorage usage)
