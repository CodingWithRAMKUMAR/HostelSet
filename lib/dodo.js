// lib/dodo.js
// Helper for Dodo Payments API (Test Mode)

const DODO_API_KEY = process.env.DODO_API_KEY;
const DODO_API_BASE = 'https://api.dodopayments.com/v1'; // verify with Dodo docs
  ...
  try {
    const response = await fetch(`${DODO_API_BASE}/payments`, {
      ...
      body: JSON.stringify({
        ...
        payment_methods: ['upi', 'card', 'netbanking'], // UPI is primary
